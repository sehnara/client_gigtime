...
const mockDict = {
  key: [
    "2022-07-22,보리누리,카운터,333333",
    "2022-07-22,빽다방,음료제조,333333",
    "2022-07-24,보리누리,카운터,333333",
  ],
  address: {
    보리누리: "보리누리의 주소",
    빽다방: "빽다방의 주소",
        ...
        mockDict.key.map((e) => {
          ...
          return (
            <List
              ...
              datas={mockDict["2022-07-22,보리누리,카운터,333333"]} // 수정해야함
            />
          );
        })}
    </div>
