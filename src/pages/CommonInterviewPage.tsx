    ...
    return (
        <div>
            ...
            <div className="flex flex-col h-screen justify-center items-center relative mx-8">
                ...
                <video ref={localVideoRef} muted playsInline autoPlay className="shadow-xl shadow-gray-500 -mt-24" />
                <video id="remotevideo" ref={remoteVideoRef} playsInline autoPlay className="shadow-xl shadow-gray-500 pt-24" />
            </div>
        </div>
    );
};
